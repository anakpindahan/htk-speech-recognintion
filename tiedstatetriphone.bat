...
HVite -C config\extractmfcc.conf -H hmms\hmm.15\macros -H hmms\hmm.15\hmmdefs -S config\test.scp -l * -i output\recout.mlf -w data\grammar\grammar.slf -p 0.0 -s 5.0 output\dict output\tiedlist
HResults -I output\testref.mlf output\tiedlist output\recout.mlf